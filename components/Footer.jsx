        ...
        <footer className="bg-black text-white pt-14 pb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                ...
                <div className="sm:ml-0 ml-8">
                    ...
                    <br></br>
                    <Link href="/about" className="hover:text-gray-500 text-base leading-4 mt-6 text-white-800 cursor-pointer">
                    <p >About Us</p>
                    </Link>
                    <br></br>
                    <Link href="/contact" className="hover:text-gray-500 text-base leading-4 mt-6 text-white-800 cursor-pointer">
                    <p >Contact Us</p>
                    </Link>
                </div>
                <div className="sm:ml-0 ml-8">
